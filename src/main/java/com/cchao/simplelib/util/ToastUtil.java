...
public class ToastUtil {
     ...
     * @param resId 资源Id
     */
    public static void showToastSafe(final @StringRes int resId) {
        sHandler.post(new Runnable() {
            @Override
            public void run() {
     ...
     * @param args  参数
     */
    public static void showToastSafe(final @StringRes int resId, final Object... args) {
        sHandler.post(new Runnable() {
            @Override
            public void run() {
     ...
     * @param args   参数
     */
    public static void showToastSafe(final String format, final Object... args) {
        sHandler.post(new Runnable() {
            @Override
            public void run() {
    ...
    private static void showToast(@StringRes int resId, int duration) {
        showToast(LibCore.getContext().getResources().getText(resId).toString(), duration);
    }
    ...
    private static void showToast(@StringRes int resId, int duration, Object... args) {
        showToast(String.format(LibCore.getContext().getResources().getString(resId), args), duration);
    }
    ...
    private static void showToast(CharSequence text, int duration) {
        ...
        if (sToast == null) {
            sToast = Toast.makeText(LibCore.getContext(), text, duration);
        } else {
            sToast.setText(text);
