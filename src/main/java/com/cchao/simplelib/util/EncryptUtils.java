...
public class EncryptUtils {
    ...
    public static String encryptMD2ToString(String data) {
        return encryptMD2ToString(data.getBytes(UTF8));
    }
    ...
    public static String encryptMD5ToString(String data) {
        return encryptMD5ToString(data.getBytes(UTF8));
    }
    ...
    public static String encryptMD5ToString(String data, String salt) {
        return ConvertUtils.bytes2HexString(encryptMD5((data + salt).getBytes(UTF8)));
    }
    ...
    public static String encryptSHA1ToString(String data) {
        return encryptSHA1ToString(data.getBytes(UTF8));
    }
    ...
    public static String encryptSHA224ToString(String data) {
        return encryptSHA224ToString(data.getBytes(UTF8));
    }
    ...
    public static String encryptSHA256ToString(String data) {
        return encryptSHA256ToString(data.getBytes(UTF8));
    }
    ...
    public static String encryptSHA384ToString(String data) {
        return encryptSHA384ToString(data.getBytes(UTF8));
    }
    ...
    public static String encryptSHA512ToString(String data) {
        return encryptSHA512ToString(data.getBytes(UTF8));
    }
     ...
     */
    public static final String DES_TRANSFORMATION = "DES/ECB/NoPadding";
     ...
     * <p>填充方式有：NoPadding、ZerosPadding、PKCS5Padding</p>
     */
    public static final String TRIPLE_DES_TRANSFORMATION = "DESede/ECB/NoPadding";
    ...
    public static byte[] encrypt3DES(byte[] data, byte[] key) {
        return desTemplet(data, key, TRIPLE_DES_ALGORITHM, TRIPLE_DES_TRANSFORMATION, true);
    }
    ...
    public static byte[] decrypt3DES(byte[] data, byte[] key) {
        return desTemplet(data, key, TRIPLE_DES_ALGORITHM, TRIPLE_DES_TRANSFORMATION, false);
    }
     ...
     * <p>填充方式有：NoPadding、ZerosPadding、PKCS5Padding</p>
     */
    public static final String AES_TRANSFORMATION = "AES/ECB/NoPadding";
