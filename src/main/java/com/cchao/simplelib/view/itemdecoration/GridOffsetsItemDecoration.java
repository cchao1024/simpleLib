package com.cchao.simplelib.view.itemdecoration;
...
public class GridOffsetsItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public GridOffsetsItemDecoration setVerticalItemOffsets(int verticalItemOffsets) {
        this.mVerticalItemOffsets = verticalItemOffsets;
        return this;
    }

    public GridOffsetsItemDecoration setHorizontalItemOffsets(int horizontalItemOffsets) {
