...
/**
 * Description: 局部模块 网络出错的View
 *
 * @author cchao
 * @version 2017/8/4
 */

public class FieldNetErrorViewImpl extends LinearLayout implements INetErrorView {

    View mReloadButton;

    public FieldNetErrorViewImpl(Context context) {
        this(context, null);
    }

    public FieldNetErrorViewImpl(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public FieldNetErrorViewImpl(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
